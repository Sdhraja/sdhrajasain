#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Team SDH
...
CorrectUsername = "Alexanderraja"
CorrectPassword = "Alexander007"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Alexanderraja
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		os.system('clear')
		print logo
		jalan(' \033[1;92m     Notice:тШЮ \033[1;93mWe Are Anonymous' )
                jalan(' \033[1;92m     Notice:тШЮ \033[1;97mWe Are Never Forgive' )
                jalan(' \033[1;92m     Notice:тШЮ \033[1;97mWe Are Never Forget ' )
                jalan(' \033[1;92m     Notice:тШЮ \033[1;97mBCz ' )
		jalan(' \033[1;92m     Notice:тШЮ \033[1;97mWe Are The Legends' )
                jalan(' \033[1;92m    Warning:тШЮ \033[1;95mWe Are Sdhiens' )
		print "\033[1;95m      тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАв\033[1;96mTeamSdh\033[1;95mтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mB4Baloch\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By Team Sdh--тАвтЧИтАв---┬╗" #Dev:Sindhi_Dark_Hunters
...
: \033[1;93m.Sindhi Hacker  Alexander Raja.... \033[1;93m :
тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд.' 
                Connect us Facebook 
               +FB.com/SDH.RAJA"""
